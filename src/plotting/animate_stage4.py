...
variables = ['Visibility','Maximum/Composite radar reflectivity','Total Cloud Cover','Wind speed (gust)']
colors = ['viridis','gist_rainbow','cividis','plasma']
ranges = [(0,90000),(-30,75),(0,100),(0,10)]
