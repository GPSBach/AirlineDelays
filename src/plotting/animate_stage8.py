...
for i in range(num_steps):
    ...
    for ix,data in enumerate(datas):
        ...
        ax.plot_surface(lons,lats,-1*Z_DEN,cstride=stride,rstride=stride,facecolors=fcolors, vmin=ranges[ix][0], vmax=ranges[ix][0], shade=False, zorder=1)
        ax.plot_surface(lons,lats,-1*Z_MIA,cstride=stride,rstride=stride,facecolors=fcolors, vmin=ranges[ix][0], vmax=ranges[ix][0], shade=False, zorder=1)
